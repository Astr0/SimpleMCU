...
namespace smcu
{
	namespace io
	{
		...
		{			
			...
			typedef priv::UpdateCounter<SMCU_UPDATECOUNTER> UpdateCounter;
			typedef priv::UpdateCheck<UpdateCounter> UpdateCheck;
		}
		static constexpr types::UpdateCounter UpdateCounter;
	}
}
